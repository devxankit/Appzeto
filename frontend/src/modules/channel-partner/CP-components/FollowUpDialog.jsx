...
const FollowUpDialog = ({ 
  ...
  useEffect(() => {
    if (initialData) {
      const date = initialData.date || initialData.followupDate || initialData.scheduledDate || ''
      const time = initialData.time || initialData.followupTime || initialData.scheduledTime || ''
