...
const CP_not_picked = () => {
  ...
  const fetchLeads = async () => {
    ...
    try {
      ...
      const notPickedLeads = leads.filter(lead => lead.status === 'not_picked')
      setLeadsData(notPickedLeads)
    } catch (error) {
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-base font-semibold text-gray-900 truncate">
              {lead.leadProfile?.name || lead.name || lead.phone || 'Unknown'}
            </h3>
          ...
          <div className="text-right flex-shrink-0">
            <p className="text-sm font-bold text-rose-600">{lead.attempts || 0} attempts</p>
          </div>
        </div>

      {/* Last Attempt & Phone */}
      <div className="flex justify-between items-center">
        <span className="text-xs text-gray-500">Last attempt: {lead.lastAttempt || 'N/A'}</span>
      ...
      <div className="flex items-center justify-between pt-2 border-t border-gray-100">
        ...
        <div className="flex items-center space-x-1">
          ...
          <button
            ...
            className="p-2 bg-white text-blue-600 border border-blue-200 rounded-lg hover:bg-blue-50 transition-all duration-200"
            title="Call"
          >
