...
const CP_newLeads = () => {
  ...
  const fetchLeads = useCallback(async () => {
    ...
    try {
      ...
      const filteredLeads = leads.filter(lead => lead.status === 'new')
      ...
      setTotalNewLeads(filteredLeads.length)
    } catch (error) {
  ...
  const handleStatusChange = async (leadId, newStatus) => {
    try {
      if (newStatus === 'contacted' || newStatus === 'connected') {
  ...
  const handleNotInterested = async (leadId) => {
    try {
      await cpLeadService.updateLeadStatus(leadId, 'not_converted', 'Not interested')
  ...
  const confirmDelete = async () => {
    if (leadToDelete) {
      try {
        await cpLeadService.updateLeadStatus(leadToDelete, 'not_converted', 'Not interested')
        toast.success?.('Lead marked as not interested', {
          title: 'Success',
          duration: 3000
        })
  ...
  const handleConnectedFormSubmit = async (e) => {
    ...
    try {
      ...
      await cpLeadService.updateLeadStatus(selectedLeadForForm, 'connected')
      
      // Then create lead profile
      const profileData = {
        name: connectedForm.name,
        businessName: connectedForm.name,
        email: '',
        projectType: {
      ...
      await cpLeadService.createLeadProfile(selectedLeadForForm, profileData)
    ...
    return (
      ...
      >
        ...
        <button
          ...
          className="bg-white text-blue-600 border border-blue-200 px-3 py-1.5 rounded-lg hover:bg-blue-50 transition-all duration-200 text-xs font-medium"
        >
          Call
        </button>
              ...
              >
                <div className="py-1.5">
                  <button
                    ...
                    className="w-full px-4 py-2.5 text-left text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition-colors duration-200"
                  >
                    Contacted
                  </button>
                  <button
      ...
      <main className="max-w-4xl mx-auto px-4 pt-16 pb-20 sm:px-6 lg:px-8">
         ...
         <div>
           ...
           <motion.div 
             ...
             className="mb-6"
           >
             <div className="bg-gradient-to-br from-blue-50 via-blue-100 to-indigo-200 rounded-xl p-4 shadow-lg border border-blue-300/40">
               <div className="flex items-center justify-between">
                 ...
                 <div className="flex items-center space-x-3 flex-1">
                   ...
                   <div>
                     <h1 className="text-lg font-bold text-blue-900">New Leads</h1>
                     <p className="text-blue-700 text-xs">Manage and track your potential customers</p>
                   </div>
                 </div>
                 ...
                 <div className="bg-white/70 backdrop-blur-sm rounded-lg px-3 py-2 shadow-sm border border-white/30">
                   <div className="text-center">
                     ...
                     <p className="text-xl font-bold text-blue-900">{totalNewLeads}</p>
            ...
            >
              ...
              <form onSubmit={handleConnectedFormSubmit} className="p-6 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 resize-none"
                    />
                  </div>
                </div>
                ...
                <div className="flex space-x-3 pt-4">
                  ...
                  <button
                    type="submit"
                    className="flex-1 px-4 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-lg hover:from-blue-600 hover:to-indigo-700 transition-all duration-200 font-medium shadow-lg"
                  >
                    Save Lead
                  </button>
                </div>
