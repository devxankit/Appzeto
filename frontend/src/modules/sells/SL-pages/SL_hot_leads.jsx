...
const SL_hot_leads = () => {
  ...
  // Mock hot leads data with names
  const hotLeadsData = [
    {
      id: 1,
      name: 'Sarah Wilson',
        ...
        <div className="hidden lg:block">
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className="col-span-8 space-y-6">
              ...
              >
                <div>
                  ...
                  <p className="text-gray-600 mt-2">High-priority leads requiring immediate attention</p>
                </div>
                <div className="flex items-center space-x-4">
            ...
            <div className="col-span-4 space-y-6">
              ...
              >
                <h3 className="text-lg font-bold text-red-900 mb-4">Hot Leads Analytics</h3>
