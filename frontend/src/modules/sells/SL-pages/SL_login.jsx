...
const SL_login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await loginSales(formData.email, formData.password)
      ...
      if (response.success) {
        ...
        // Show success toast
        toast.login(`Welcome back, ${response.data.sales.name}!`, {
      ...
      >
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8 relative overflow-hidden">
          ...
          >
            ...
            <p className="text-gray-600 text-sm">Sign in to your sales account</p>
          </motion.div>
