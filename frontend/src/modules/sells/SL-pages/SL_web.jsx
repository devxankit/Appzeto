...
const SL_web = () => {
  ...
  // Mock web leads data with categories
  const webLeadsData = [
    {
      id: 1,
      name: 'John Smith',
  ...
  const filteredLeads = webLeadsData.filter(lead => {
  ...
  const handleWhatsApp = (phone) => {
    const message = encodeURIComponent("Hello! I'm following up on your website development project. How can I help you today?")
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-shrink-0">
            <div className="w-10 h-10 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-full flex items-center justify-center shadow-sm">
        ...
        <div className="text-right flex-shrink-0">
          <p className="text-sm font-bold text-cyan-600">{lead.websiteType}</p>
        </div>
      </div>

      {/* Web Info */}
      <div className="flex justify-between items-center">
        <span className="text-xs text-gray-500">Web Lead</span>
    ...
    return (
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center space-x-3">
          {/* Avatar */}
          <div className="flex-shrink-0">
            <div className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-full flex items-center justify-center shadow-sm">
        ...
        {/* Website Type */}
        <div className="text-right flex-shrink-0">
          <p className="text-lg font-bold text-cyan-600">{lead.websiteType}</p>
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto px-4 pt-16 pb-20 sm:px-6 lg:px-8">
         ...
         <div className="lg:hidden">
           ...
           <motion.div 
             ...
             className="mb-6"
           >
             <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-xl p-4 shadow-md border border-cyan-200/30">
               <div className="flex items-center justify-between">
                 ...
                 <div className="bg-white rounded-lg px-4 py-3 shadow-md border border-white/20 ml-3">
                   <div className="text-center">
                     <p className="text-xs text-cyan-600 font-medium mb-0.5">Total</p>
                     <p className="text-2xl font-bold text-cyan-900 leading-none">{webLeadsData.length}</p>
                     <p className="text-xs text-cyan-600 font-medium mt-0.5">Web Leads</p>
                   </div>
                 </div>
               </div>
             </div>
          ...
          {showFilters && (
            ...
            >
              ...
              <div>
                <h4 className="text-sm font-semibold text-gray-700 mb-2">Website Type</h4>
          ...
          >
            <p className="text-gray-600 text-sm">
              Showing {filteredLeads.length} of {webLeadsData.length} web leads
            </p>
          </motion.div>
            ...
            {filteredLeads.length === 0 && (
              ...
              >
                <div className="max-w-md mx-auto">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">No web leads found</h3>
                  <p className="text-gray-600">
                    {searchTerm ? 'Try adjusting your search criteria or filters.' : 'No web leads match your current filters.'}
                  </p>
                </div>
              </motion.div>
            )}
        ...
        <div className="hidden lg:block">
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className="col-span-8 space-y-6">
              ...
              >
                <div>
                  <h1 className="text-3xl font-bold text-gray-900">Web</h1>
                  <p className="text-gray-600 mt-2">Website development leads</p>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="bg-gradient-to-r from-cyan-500 to-cyan-600 text-white px-6 py-3 rounded-xl">
                    <span className="text-sm font-semibold">Total: {webLeadsData.length}</span>
                  </div>
              ...
              >
                ...
                {showFilters && (
                  ...
                  >
                    {/* Website Type Filters */}
                    <div>
                      <h4 className="text-sm font-semibold text-gray-700 mb-3">Website Type</h4>
                      <div className="flex flex-wrap gap-2">
                        {filters.map((filter) => (
                          <button
                            key={filter.id}
                ...
                >
                  <div className="max-w-md mx-auto">
                    <div className="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6">
                      <FiGlobe className="text-gray-400 text-3xl" />
                    </div>
                    <h3 className="text-2xl font-semibold text-gray-900 mb-4">No web leads found</h3>
            ...
            <div className="col-span-4 space-y-6">
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-2xl p-6 shadow-xl border border-cyan-200/50"
              >
                <h3 className="text-lg font-bold text-cyan-900 mb-4">Web Lead Analytics</h3>
                
                 <div className="space-y-4">
                   <div className="flex items-center justify-between">
                     <span className="text-cyan-700 text-sm font-medium">Total Web Leads</span>
                     <span className="text-cyan-900 text-xl font-bold">{webLeadsData.length}</span>
                   </div>
                   <div className="flex items-center justify-between">
                     <span className="text-cyan-700 text-sm font-medium">E-commerce</span>
                     <span className="text-cyan-900 text-xl font-bold">{webLeadsData.filter(lead => lead.websiteType === 'E-commerce').length}</span>
                   </div>
                   <div className="flex items-center justify-between">
                     <span className="text-cyan-700 text-sm font-medium">Corporate</span>
                     <span className="text-cyan-900 text-xl font-bold">{webLeadsData.filter(lead => lead.websiteType === 'Corporate').length}</span>
                   </div>
                   <div className="flex items-center justify-between">
                     <span className="text-cyan-700 text-sm font-medium">Other Types</span>
                     <span className="text-cyan-900 text-xl font-bold">{webLeadsData.filter(lead => !['E-commerce', 'Corporate'].includes(lead.websiteType)).length}</span>
                   </div>
                 </div>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-3">
                  <button className="w-full bg-cyan-500 text-white font-semibold py-3 px-4 rounded-xl hover:bg-cyan-600 transition-colors duration-200 flex items-center justify-center space-x-2">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 bg-cyan-100 rounded-full flex items-center justify-center">
                      <FiGlobe className="text-cyan-600 text-sm" />
                    </div>
                    <div className="flex-1">
