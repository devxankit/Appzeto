...
const SL_dq_sent = () => {
  ...
  const fetchLeads = async () => {
    ...
    try {
      ...
      const response = await salesLeadService.getLeadsByStatus('dq_sent', params)
  ...
  const handleWhatsApp = (phone) => {
    const message = encodeURIComponent("Hello! I'm following up on the D&Q I sent. Do you have any questions?")
    ...
    <div className="p-4 space-y-3">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="text-right flex-shrink-0">
          <p className="text-sm font-bold text-purple-600">{lead.dqDate}</p>
        </div>
      </div>

      {/* D&Q Info */}
      <div className="flex justify-between items-center">
        <span className="text-xs text-gray-500">D&Q sent</span>
  ...
  const DesktopLeadCard = ({ lead }) => {
    ...
    <div className="p-4 space-y-3">
      ...
      <div className="flex items-center space-x-3">
        ...
        {/* Date */}
        <div className="text-right flex-shrink-0">
          <p className="text-lg font-bold text-purple-600">{lead.dqDate}</p>
        </div>
      </div>
         ...
         <div className="lg:hidden">
               ...
               <div className="flex items-center justify-between">
                 ...
                 <div className="bg-white rounded-lg px-4 py-3 shadow-md border border-white/20 ml-3">
                   <div className="text-center">
                     ...
                     <p className="text-2xl font-bold text-purple-900 leading-none">{leadsData.length}</p>
                     <p className="text-xs text-purple-600 font-medium mt-0.5">D&Q Sent</p>
                   </div>
                 </div>
               </div>
             </div>
          ...
          {showFilters && (
            ...
            >
              {/* DQ Status Filters */}
              <div>
                <h4 className="text-sm font-semibold text-gray-700 mb-2">DQ Status</h4>
          ...
          >
            <p className="text-gray-600 text-sm">
              Showing {leadsData.length} D&Q leads
            </p>
          </motion.div>
          ...
          >
            <AnimatePresence>
              {isLoading ? (
                ...
                >
                  <FiSend className="w-12 h-12 text-gray-400 mx-auto mb-4" />
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No D&Q Sent Leads</h3>
                  <p className="text-gray-500">No leads have been sent D&Q yet.</p>
                </motion.div>
              ) : (
        ...
        <div className="hidden lg:block">
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className="col-span-8 space-y-6">
              ...
              >
                <div>
                  <h1 className="text-3xl font-bold text-gray-900">D&Q Sent</h1>
                  <p className="text-gray-600 mt-2">Leads with D&Q sent</p>
                </div>
                ...
                <AnimatePresence>
                  {isLoading ? (
                    ...
                    >
                      ...
                      <h3 className="text-xl font-medium text-gray-900 mb-2">No D&Q Sent Leads</h3>
                      <p className="text-gray-500">No leads have been sent D&Q yet.</p>
                    </motion.div>
                  ) : (
                    leadsData.map((lead, index) => (
                ...
                >
                  <div className="max-w-md mx-auto">
                    <div className="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6">
                      <FiSend className="text-gray-400 text-3xl" />
                    </div>
                    <h3 className="text-2xl font-semibold text-gray-900 mb-4">No D&Q leads found</h3>
                    <p className="text-gray-600 text-lg">
                      {searchTerm ? 'Try adjusting your search criteria or filters.' : 'No D&Q leads match your current filters.'}
                    </p>
                  </div>
                </motion.div>
              )}
            ...
            <div className="col-span-4 space-y-6">
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 shadow-xl border border-purple-200/50"
              >
                <h3 className="text-lg font-bold text-purple-900 mb-4">D&Q Analytics</h3>
                
                 <div className="space-y-4">
                   <div className="flex items-center justify-between">
                     <span className="text-purple-700 text-sm font-medium">Total D&Q Sent</span>
                     <span className="text-purple-900 text-xl font-bold">{leadsData.length}</span>
                   </div>
                   <div className="flex items-center justify-between">
                     <span className="text-purple-700 text-sm font-medium">This Week</span>
                     <span className="text-purple-900 text-xl font-bold">-</span>
                   </div>
                   <div className="flex items-center justify-between">
                     <span className="text-purple-700 text-sm font-medium">Awaiting Response</span>
                     <span className="text-purple-900 text-xl font-bold">{leadsData.length}</span>
                   </div>
                   <div className="flex items-center justify-between">
                     <span className="text-purple-700 text-sm font-medium">Response Rate</span>
                     <span className="text-purple-900 text-xl font-bold">0%</span>
                   </div>
                 </div>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-3">
                  <button className="w-full bg-purple-500 text-white font-semibold py-3 px-4 rounded-xl hover:bg-purple-600 transition-colors duration-200 flex items-center justify-center space-x-2">
                    <FiSend className="text-lg" />
                    <span>Send New D&Q</span>
                  </button>
              ...
              >
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-900">D&Q sent</p>
