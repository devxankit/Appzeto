...
const SL_demo_sent = () => {
  ...
  const handleWhatsApp = (phone) => {
    const message = encodeURIComponent("Hello! I'm following up on the demo I sent. Do you have any questions?")
         ...
         <div>
               ...
               <div className="flex items-center justify-between">
                 ...
                 <div className="bg-white rounded-lg px-4 py-3 shadow-md border border-white/20 ml-3">
                   <div className="text-center">
                     ...
                     <p className="text-xs text-teal-600 font-medium mt-0.5">Demo Sent</p>
                   </div>
                 </div>
               </div>
             </div>
          ...
          >
            <p className="text-gray-600 text-sm">
              Showing {leadsData.length} demo sent leads
            </p>
          </motion.div>
            ...
            <AnimatePresence>
              {isLoading ? (
                ...
                >
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No Demo Sent Leads</h3>
                  <p className="text-gray-500">No leads have been sent demo yet.</p>
                </motion.div>
              ) : (
