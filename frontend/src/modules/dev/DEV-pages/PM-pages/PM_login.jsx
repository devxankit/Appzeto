...
import { loginPM, createDemoPM, isPMAuthenticated } from '../../DEV-services/pmAuthService'
...
const PM_login = () => {
  ...
  const handleCreateDemo = async () => {
    ...
    try {
      ...
      // Show success toast
      toast.success('Demo PM created successfully! You can now login with pm@demo.com / password123', {
        title: 'Demo PM Created',
        duration: 5000
      })
      
      setErrors({ 
        general: 'Demo PM created successfully! You can now login with pm@demo.com / password123' 
      })
    } catch (error) {
      const errorMessage = error.message || 'Failed to create demo PM'
        ...
        >
          <div className="text-center">
            ...
            <div className="space-y-1 text-xs text-gray-600 mb-3">
              <p><span className="font-medium">Email:</span> pm@demo.com</p>
