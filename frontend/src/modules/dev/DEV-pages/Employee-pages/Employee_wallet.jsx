            ...
            >
              <div className="flex justify-between items-center mb-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs font-bold text-gray-800 uppercase tracking-wider">Reward Progress</span>
                </div>
              ...
              <div className="flex justify-between items-center mt-2">
                <p className="text-[10px] font-medium text-gray-600">
                  {walletData.rewardProgress.tasksCompleted}/{walletData.rewardProgress.totalTasks} Tasks Done
                </p>
                <p className="text-[10px] font-bold text-teal-600 italic">
                  {walletData.rewardProgress.completionRate >= walletData.rewardProgress.rewardTarget
                    ? "Target Reached! 🏆"
                    : `Reach ${walletData.rewardProgress.rewardTarget}% to win reward`}
                </p>
              </div>
            </motion.div>
                    ...
                    <div className="flex justify-between items-end mb-3">
                      <div>
                        <div className="flex items-center space-x-2 mb-1">
                          ...
                          <h4 className="text-white font-bold text-lg tracking-wide uppercase">Reward Achievement Progress</h4>
                        </div>
                        <p className="text-white/60 text-sm">
                          Complete your tasks with at least <span className="text-white font-bold">{walletData.rewardProgress.rewardTarget}%</span> ratio to earn special rewards!
                        </p>
                      </div>
                      <div className="text-right">
                        ...
                        <p className="text-white/60 text-xs font-medium uppercase tracking-widest mt-1">Completion Ratio</p>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between mt-4">
                      <div className="flex space-x-6">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-white/70 text-sm font-medium">Tasks: <span className="text-white">{walletData.rewardProgress.tasksCompleted} / {walletData.rewardProgress.totalTasks}</span></span>
                        </div>
                        <div className="flex items-center space-x-2">
